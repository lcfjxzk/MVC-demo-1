...
$tabBar.on("click", "li", function (e) {
  ...
  var index = $li.index();
  console.log(index);
  $tabContent.children() //找到tabContent的子元素
  .eq(index).addClass("active") //第index个元素变成display: "block"
  .siblings().removeClass("active"); //除第index个元素以外的元素变成display: "none"
...
//# sourceMappingURL=main.79795811.js.map